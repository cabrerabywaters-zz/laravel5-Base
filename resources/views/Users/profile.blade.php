...
@section('content')
    ...
    <section id="main-content">
        ...
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> Información del Usuario</h3>
                    ...
                    <div class="form-panel">
                        ...
                        <form class="form-horizontal tasi-form" method="get">
                            <div class="form-group has-success">
                                <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">Input with
                                    success</label>
                            ...
                            <div class="form-group has-warning">
                                <label class="col-sm-2 control-label col-lg-2" for="inputWarning">Input with
                                    warning</label>
